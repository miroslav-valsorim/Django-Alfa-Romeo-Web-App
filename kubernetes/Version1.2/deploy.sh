...
echo "  8. Applying Django Deployment..."
kubectl apply -f django-deployment.yml

echo "  9. Applying Django Service..."
kubectl apply -f django-service.yml

echo "  10. Applying HPA (Horizontal Pod Autoscaler)..."
kubectl apply -f hpa.yml

echo "  11. Applying Pod Disruption Budget..."
kubectl apply -f poddisruptionbudget.yml

echo "  12. Applying Network Policy..."
kubectl apply -f networkpolicy.yml

echo "  13. Applying Ingress..."
...
kubectl wait --for=condition=available --timeout=600s deployment/alfa-romeo-web -n alfa-romeo || print_warning "Django took longer to start"
